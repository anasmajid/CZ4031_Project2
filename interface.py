...
class App(object):
    ...
    def __init__(self,parent):
        ...
        self.dbName_entry.insert(tk.END,"postgres")
        self.username_entry.insert(tk.END,"postgres")
        self.password_entry.insert(tk.END,"postgres")
    ...
    def getPlan(self):
        ...
        try:
            ...
            queryPlans = backend.getQueryPlan(inputSql) #gets list of query plans from BE, [QEP, AQP]
